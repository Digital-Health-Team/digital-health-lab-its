import { CollageItem, HexItem, TeamLead, TeamSection } from "../Types/orgChartTypes";

export const SPINE_ROW_H = 100;
...
export const HEX_ITEMS: HexItem[] = [
    {
        cx: 50,
        cy: 50,
        size: 44,
...
export const ACT2_COLLAGE: CollageItem[] = [
    {
...
export const ACT3_COLLAGE: CollageItem[] = [
    {
